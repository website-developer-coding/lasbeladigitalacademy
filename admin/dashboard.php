...
?>
<div class="d-flex justify-content-end gap-2 mb-3"><a class="btn btn-outline-primary" href="account.php"><i class="bi bi-person-gear me-1"></i>My Account</a><a class="btn btn-outline-primary" href="admins/create.php"><i class="bi bi-person-plus me-1"></i>Add Administrator</a></div>
